...
class PredictionMarketFactory(gl.Contract):
    ...
    def _resolve_now(self, market, disputant_context=""):
        ...
        raw = gl.eq_principle.prompt_comparative(get_answer, f"Both results must carry the same 'outcome' value.")
        try:
            data = json.loads(raw)
        ...
        market.rationale = f"Validators reached consensus: {outcome}."
